        ...
        >
          ...
          >
            ...
            <button
              type="button"
              onClick={onClose}
              className="absolute right-5 top-5 z-20 flex h-11 w-11 cursor-pointer items-center justify-center rounded-full bg-white/10 text-white backdrop-blur-xl transition-colors hover:bg-white/18"
              title="关闭"
            >
              <X className="h-5 w-5" />
            </button>

            <div className="relative z-10 grid h-full w-full grid-rows-[auto_1fr] px-6 pb-8 pt-16 md:grid-cols-[minmax(320px,0.88fr)_minmax(420px,1.12fr)] md:grid-rows-1 md:gap-10 md:px-16 md:py-14 lg:pl-32 lg:pr-24 xl:pl-40 xl:pr-28">
              <section className="flex min-h-0 flex-col items-center justify-end md:justify-center">
                ...
                <div className="relative aspect-square w-full max-w-[360px] overflow-hidden rounded-[8px] bg-white/10 shadow-2xl shadow-black/35">
                  {music.cover ? (
                    <Image
                      src={music.cover}
                      alt={music.title}
              ...
              <section className="mt-8 min-h-0 overflow-hidden md:mt-0 md:pl-8 lg:pl-14">
                <div
